# Chapter 5: The memory artifact and online improvement
...
Run:
```
python chapters/ch05/memory_as_artifacts.py
```
...
Run:
```
python chapters/ch05/minimal_memrl.py
```
...
Run:
```
python chapters/ch05/minimal_grpo.py
```
...
Run:
```
python chapters/ch05/online_memory_loop.py
```
